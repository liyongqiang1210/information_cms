					...
					var tableIns = table
							.render({
								...
								cols : [ [ // 表头
									...
									// 当前数据总数
									total = count;
									console.log("数据表格渲染完成：total = " + total);
								}
							});
												...
												.reload({
													...
													where : {
														roleName : $(
																...
																.val(),
														available : $(
																'#available_search>option:selected')
																.val()
													},
													page : {
														curr : 1,
...
function bindingEditEvent(form, id, roleName, roleDesc) {
	...
	var html = '<form class="layui-form" id="form" style="margin:20px;">'
			+ '<div class="layui-form-item"><label class="layui-form-label">角色名</label><div class="layui-input-block"><input type="text" id="roleName" lay-verify="roleName" placeholder="请输入角色名" autocomplete="off"  class="layui-input" value='
			+ roleName
			+ '><input type="text" id="roleNameDefault" value='
			+ roleName
			+ ' hidden></div></div>'
			+ '<div class="layui-form-item layui-form-text"><label class="layui-form-label">角色描述</label><div class="layui-input-block"><textarea id="roleDesc" required  lay-verify="roleDesc" placeholder="请输入角色描述" class="layui-textarea">'
